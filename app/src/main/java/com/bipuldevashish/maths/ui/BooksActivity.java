...
public class BooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new BooksActivity.Browser_Home());
        webView.setWebChromeClient(new BooksActivity.ChromeClient());
    ...
    private void loadWebSite() {
        webView.loadUrl("https://go.givni.in/Goswami%20Mathematics/book.php");
    }
