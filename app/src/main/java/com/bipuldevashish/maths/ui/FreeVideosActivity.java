...
public class FreeVideosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new FreeVideosActivity.Browser_Home());
        webView.setWebChromeClient(new FreeVideosActivity.ChromeClient());
    ...
    private void loadWebSite() {
        webView.loadUrl("https://go.givni.in/Goswami%20Mathematics/allvideo.php");
    }
