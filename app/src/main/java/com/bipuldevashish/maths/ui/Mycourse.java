...
public class Mycourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new Mycourse.Browser_Home());
        webView.setWebChromeClient(new Mycourse.ChromeClient());
    ...
    private void loadWebSite() {
        webView.loadUrl("https://go.givni.in/Goswami%20Mathematics/mycourse.php");
    }
