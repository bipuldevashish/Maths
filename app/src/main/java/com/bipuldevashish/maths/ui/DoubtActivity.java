...
public class DoubtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new DoubtActivity.Browser_Home());
        webView.setWebChromeClient(new DoubtActivity.ChromeClient());
    ...
    private void loadWebSite() {
        webView.loadUrl("https://go.givni.in/Goswami%20Mathematics/doubt.php");
    }
