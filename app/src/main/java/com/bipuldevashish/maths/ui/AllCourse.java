...
public class AllCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new AllCourse.Browser_Home());
        webView.setWebChromeClient(new AllCourse.ChromeClient());
    ...
    private void loadWebSite() {
        webView.loadUrl("https://go.givni.in/Goswami%20Mathematics/allcourse.php");
    }
